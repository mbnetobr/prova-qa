...
Funcionalidade: Editar autor
  ...
  Cenário: Editar autor com sucesso
    Quando atualizo um autor com a requisição PUT para "/Authors" com id "595"
  ...
  Esquema do Cenário: Não editar autor com valores inválidos na requisição
    Quando tento atualizar um autor com a requisição PUT para "/Authors" com <campo> com <valor> com id "595"
  ...
  Cenario: Não editar autor cujo id não exista
    Quando tento atualizar um autor com a requisição PUT para "/Authors" com id inexistente
